...
{	
	...
	override function beatHit()
	{
		...
		{
			case 1:
				createCoolText(['TOO', 'MANY', 'PEOPLE TO', 'LIST']);
			// credTextShit.visible = true;
			case 3:
				addMoreText('PRESENYT');
			// credTextShit.text += '\npresent...';
			...
			// credTextShit.screenCenter();
			case 5:
					createCoolText(['This mod will', 'kill']);
			case 7:
					addMoreText('your fingers lmao');
			// credTextShit.text += '\nNewgrounds';
			case 8:
				deleteCoolText();
			//	ngSpr.visible = false;
			...
			// credTextShit.text += '\nNight';
			case 15:
				addMoreText('WIIK FIVE'); // credTextShit.text += '\nFunkin';
			case 16:
				skipIntro();
		}
	}
