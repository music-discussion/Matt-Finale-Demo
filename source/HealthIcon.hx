...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		animation.add('swordmattnew', [35, 36], 0, false, isPlayer);
		animation.add('swordmadmatt', [36, 37], 0, false, isPlayer);
		animation.add('swordchillmatt', [35, 36], 0, false, isPlayer);
		animation.add('swordhappymatt', [35, 36], 0, false, isPlayer);
		animation.add('chillmatt', [35, 36], 0, false, isPlayer);
